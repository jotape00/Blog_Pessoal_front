...
export class TemaService {
  ...
  putTema(tema: Tema): Observable<Tema>{
    return this.http.put<Tema>("https://blogpessoaldojotape.herokuapp.com/temas", tema, this.token)
  }

  deleteTema(id: number){
    return this.http.delete("https://blogpessoaldojotape.herokuapp.com/temas/${id}", this.token)
  }
}